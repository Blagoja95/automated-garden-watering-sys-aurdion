...
//Digital output for reley, button for manual opening of solenodi, tilt sensor and red led diode.
...
//button to maunally open valve for short period of time
int button1 = A1; 
*/
